...
const StyledTableContainer = styled.div`
  ...
  table {
    ...
    tbody tr {
      &:hover,
      &:focus {
        border: 1px dashed var(--first-color-light);
      }
    }
                    ...
                    <tr key={i} ref={el => (revealProjects.current[i] = el)}>
                      ...
                      <td className="links">
                        <div>
                          ...
                          {ios && (
                            <StyledIconLink href={ios} aria-label="Apple App Store Link">
                              <Icon name="AppStore" />
                            </StyledIconLink>
                          )}
                          {android && (
                            <StyledIconLink href={android} aria-label="Google Play Store Link">
                              <Icon name="PlayStore" />
                            </StyledIconLink>
                          )}
                        </div>
